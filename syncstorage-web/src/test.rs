...
use super::*;
use crate::{
    api::{auth::HawkPayload, extractors::BsoBody},
    middleware,
};
    ...
    ($settings: expr) => {
        test::init_service(
            App::new()
                ...
                // TODO: not ideal that we have to initialize middleware here in addition to in syncserver
                // if the two get out of sync, we could run into bugs
